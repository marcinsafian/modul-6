...
public class ForumStatisticsTestSuite {
    ...
    public void beforeTest(){
        ...
        when(statisticsMock.userNames()).thenReturn(listMock);
    ...
    public void testCalculateAdvStatisticsLessCommentsThanPosts(){
        ...
        forumStatistics.calculateAdvStatistics(statisticsMock);
        //Then
        Assert.assertEquals(10, forumStatistics.getPostsQty());
        Assert.assertEquals(2, forumStatistics.getCommentsQty());
        Assert.assertEquals(1, forumStatistics.getPostsAvgPerUser(), 0.01);
        Assert.assertEquals(0.2, forumStatistics.getCommentsAvgPerUser(), 0.01);
        Assert.assertEquals(0.2, forumStatistics.getCommentsAvgPerPost(), 0.01);
    }
    ...
    public void testCalculateAdvStatisticsMoreCommentsThanPosts(){
        ...
        forumStatistics.calculateAdvStatistics(statisticsMock);
        //Then
        Assert.assertEquals(20, forumStatistics.getPostsQty());
        Assert.assertEquals(40, forumStatistics.getCommentsQty());
        Assert.assertEquals(2, forumStatistics.getPostsAvgPerUser(), 0.01);
        Assert.assertEquals(4, forumStatistics.getCommentsAvgPerUser(), 0.01);
        Assert.assertEquals(2, forumStatistics.getCommentsAvgPerPost(), 0.01);
    }
    ...
    public void testCalculateAdvStatisticsWithHundredUsers(){
        ...
        Assert.assertEquals(0.2, forumStatistics.getPostsAvgPerUser(), 0.01);
